...
import com.other.param.AbstractParam;
import com.other.resp.Response;
import com.other.resp.ResponseData;
...
public class ApiRequestAspect {
     ...
     */
    @Pointcut("@annotation(com.other.annotation.ApiRequest)")
