   ...
   <div class="bk">
       <div class="xx">
         <div>
           ...
           <p class="lsyj">橙色预警</p>
            <img src="img/result/cxr.png" style="height:2.63rem;margin-left: 1.5rem">
           <p class="bf">18.3%</p>
         ...
         <div>
            <img src="img/result/cxr1.png" style="height: 2.9rem;margin-left: 1.5rem">
             <div class="sb">3倍</div>
             <p class="dyh"> > </p>
         ...
         <div style="height:2.2rem;margin-top: -0.4rem">
            <div class="xgwx"></div>
             <img style="z-index: 100;position: absolute;margin-top: -2rem;width: 2.2rem;margin-left: 0.8rem;" src="img/result/csjz.png">
       ...
       <a href="result-orange1.jsp"><img src="img/result/right.png" style="width: 1.55rem;float:right;margin-top: 1rem"></a>
   </div>
 </div>
</body>
