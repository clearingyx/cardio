...
<body>
 <div class="bjtp content">
   <div class="bk">
       <div class="xx">
         <div>
           <img src="img/result/LSS.png" style="width: 90%;margin-left: 5%;margin-top: -0.5rem">
           <p class="jkfx">血管健康风险</p>
           <p class="lsyj">绿色预警</p>
            <img src="img/result/xr1.png" style="height:2.63rem;margin-left: 1.5rem">
         ...
         <div>
            <img src="img/result/xr2.png" style="height: 2.9rem;margin-left: 1.5rem">
         ...
         <div style="height:2.2rem;margin-top: -0.4rem">
            <div class="xgwx"></div>
             <img style="z-index: 100;position: absolute;margin-top: -2rem;width: 2.2rem;margin-left: 0.8rem;" src="img/result/wei1.png">
