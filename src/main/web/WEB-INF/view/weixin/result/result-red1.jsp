    ...
    <div class="bk">
        <div class="xx">
            ...
            <div>
                ...
                <div class="ywzl"></div>
                <img src="img/result/hyw1.png" class="lyw">
                ...
                <div class="kj">
                    ...
                    <p style="margin-left: 1rem;margin-top: 1.5rem;position: absolute;color: #ffffff;font-size: 1rem;"> <2.07 </p>
                    ...
                    <p style="margin-left: 5.1rem;margin-top: 1.5rem;position: absolute;color: #ffffff;font-size: 0.9rem;"> <130/80 </p>
                ...
                <div>
                    <div class="ywzl1"></div>
                    <img src="img/result/gsshfs.png" class="lyw1">
        ...
        <a href="result-red.jsp"><img src="img/result/left.png" style="width: 1.55rem;margin-top: 1rem;position: absolute;float:left"></a>
        <a href="result-red2.jsp"><img src="img/result/right.png" style="width: 1.55rem;float:right;margin-top: 1rem"></a>
    </div>
</div>
</body>
