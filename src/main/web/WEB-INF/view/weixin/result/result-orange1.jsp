...
<head>
    ...
    <title>评估结果</title>
    <base href="<%=basePath%>">
    <link rel="stylesheet" href="css/result/result-orange.css" />
...
<div class="bjtp content">
    <div class="bk">
        <div class="xx">
            <div>
                <img src="img/result/css.png" style="width: 90%;margin-left: 5%;margin-top: -0.5rem">
            ...
            <div>
                ...
                <div class="ywzl"></div>
                <img src="img/result/ywzl.png" class="lyw">
                ...
                <div class="kj">
                    ...
                    <p style="margin-left: 1rem;margin-top: 1.5rem;position: absolute;color: #ffffff;font-size: 1rem;"> <2.59 </p>
                ...
                <div>
                    <div class="ywzl1"></div>
                    <img src="img/result/shgs.png" class="lyw1">
        ...
        <a href="result-orange.jsp"><img src="img/result/left.png" style="width: 1.55rem;margin-top: 1rem;position: absolute;float:left"></a>
        <a href="result-orange2.jsp"><img src="img/result/right.png" style="width: 1.55rem;float:right;margin-top: 1rem"></a>
    </div>
</div>
</body>
